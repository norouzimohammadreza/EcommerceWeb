        ...
        <ul class="navbar-item flex-row ml-md-auto">
            ...
            <li class="nav-item dropdown language-dropdown">
                ...
                <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('Admin/assets/img/de.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;آلمانی</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('Admin/assets/img/jp.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;ژاپنی</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('Admin/assets/img/fr.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;فرانسوی</span></a>
                    <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="{{asset('Admin/assets/img/ca.png')}}" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;انگلیسی</span></a>
                </div>
            </li>
                            ...
                            <div class="">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="">
                                            <h5 class="usr-name">محمدرضا نوروزی</h5>
